                              ...
                              child: Column(
                                children: [
                                  ...
                                  const ListTile(
                                    ...
                                    trailing: Icon(Icons.lock_outline, size: 18, color: Color(0xFF9E9E9E)),
                                  ),
                                ],
                              ),
                            ),
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 12),
                                    const _Benefit('✅ Unlimited Yaratıcı Tarifler'),
                                    const _Benefit('✅ Sınırsız Beslenme Filtreleri'),
                                    const _Benefit('✅ Haftalık Meal Plan'),
                                    const _Benefit('✅ Makro Optimization'),
